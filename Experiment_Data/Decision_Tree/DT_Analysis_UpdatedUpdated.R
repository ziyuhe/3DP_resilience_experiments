...
raw_features <- read.csv(paste0(filename_base, "_raw_features3.csv"))
synth_features <- read.csv(paste0(filename_base, "_synth_feature3.csv"))
responses <- read.csv(paste0(filename_base, "_responses3.csv"))
